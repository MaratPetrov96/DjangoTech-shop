$(function(){
  ...
  var cards = [{
    ...
    src: "https://lendedu.com/wp-content/uploads/2016/03/discover-it-for-students-credit-card.jpg"
	  ...
	  name:'МИР',
	  colore: "#318CE7",
	  src: "https://upload.wikimedia.org/wikipedia/commons/thumb/b/b9/Mir-logo.SVG.svg/1920px-Mir-logo.SVG.svg.png"
  },{
    nome: "dankort",
    colore: "#0061A8",
  ...
  $(".number").keyup(function(event){
    ...
    if(parseInt(number.substring(0, 2)) > 50 && parseInt(number.substring(0, 2)) < 56){
      ...
      selected_card = 4; 
	}else if(parseInt(number.substring(0, 4)) >2199 && parseInt(number.substring(0, 4))<2205){
		selected_card = 5;
